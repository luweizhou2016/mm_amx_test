...
//      so register can be used w/o saving/restoring:
...
class jit_generator : public Xbyak::CodeGenerator {
 ...
 public:
  ...
  uint64_t operator()(kernel_args_t... args) const {
    using jit_kernel_func_t = uint64_t (*)(const kernel_args_t... args);
...
class TileConfigScope {
 public:
  ...
  void update(const TileConfig& cfg) {
    (Singleton<TileConfiger>::get())(&cfg);
  }
